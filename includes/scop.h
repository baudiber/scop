...
/*   Updated: 2020/11/02 19:14:09 by baudibert        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void								parse_line(char *line, t_list_iterators
	*iterators, t_env *e);
void								clean_exit(const char *msg);
void								parse_obj(char *file_path, t_env *e);
void								parse_face_line(const char *line,
	t_list_iterators *iterators);
void								parse_face_line_vts(const char *line,
	t_list_iterators *iterators);
void								parse_face_line_vns(const char *line,
	t_list_iterators *iterators);
void								parse_face_line_vts_vns(const char *line,
	t_list_iterators *iterators);
...
void								init_iterator_struct(t_list_iterators
	*iterators, t_env *e);
bool								init_lists(t_env *e);
void								malloc_buffers(t_env *e);
int									vert_already_exists(t_vertex vert,
	t_env *e);
...
t_mat4x4							perspective(float fovy, float aspect_ratio,
	float near, float far);
t_mat4x4							rotation_mat4x4(t_mat4x4 src_mat,
	float angle, t_vec3 axis);
