...
/*   Updated: 2020/07/24 11:47:13 by baudibert        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 	parse_shaders(t_env *e)
{
	...
	//e->vertex_shader_src = ft_strjoinfree(e->vertex_shader_src, "\0", 1);
	//e->vertex_shader_src[ft_strlen(e->vertex_shader_src)] = '\0';
	//e->fragment_shader_src[ft_strlen(e->fragment_shader_src)] = '\0';
	//e->fragment_shader_src = ft_strjoinfree(e->fragment_shader_src, "\0", 1);
	printf("%s\n", e->vertex_shader_src);
	printf("%s\n", e->fragment_shader_src);
}
