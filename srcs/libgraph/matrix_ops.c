...
/*   Updated: 2020/11/02 19:30:56 by baudibert        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mat.m[3][0] = (vec.x * mat.m[0][0] + vec.x * mat.m[0][1] + vec.x
		* mat.m[0][2]) + mat.m[3][0];
	mat.m[3][1] = (vec.y * mat.m[1][0] + vec.y * mat.m[1][1] + vec.y
		* mat.m[1][2]) + mat.m[3][1];
	mat.m[3][2] = (vec.z * mat.m[2][0] + vec.z * mat.m[2][1] + vec.z
		* mat.m[2][2]) + mat.m[3][2];
	return (mat);
}
